...
import { MessageDataViewerComponent, useQromaWebSerial } from 'react-qroma';
import {MessageInputComponent } from 'react-qroma/dist/qroma-lib/proto-components/message-builder/MessageInputComponent'
...
export const QromaAppRequestForm = <T extends object>(props: IQromaRequestFormProps<T>) => {
