...
../generator/generator-bin/protoc *.proto --plugin=protoc-gen-dart=/root/.pub-cache/bin/protoc-gen-dart --nanopb_out=../outfiles/nanopb --python_out=../outfiles/python --dart_out=../outfiles/dart --prost_out=../outfiles/rust
...
echo "Protobuf files compiled/generated by 'docker-protobuf-compile' script using docker image qroma-project-generator-tools on " $(date) >> ../outfiles/compiled-by-qroma.txt
